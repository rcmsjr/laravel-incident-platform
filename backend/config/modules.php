...
return [
    ...
    'paths' => [
        ...
        */
        'generator' => [
            ...
            'provider' => ['path' => 'app/Providers', 'generate' => true, 'namespace' => 'Providers'],
            'repository' => ['path' => 'app/Repositories', 'generate' => false],
            'resource' => ['path' => 'app/Transformers', 'generate' => false],
            'route-provider' => ['path' => 'app/Providers', 'generate' => true, 'namespace' => 'Providers'],
    ...
    */
    'composer' => [
        ...
        'author' => [
            'name' => env('MODULE_AUTHOR_NAME', 'Roberto Souza'),
            'email' => env('MODULE_AUTHOR_EMAIL', 'rcmsjr@gmail.com'),
        ],
